...
obj1_values, obj2_values = zip(*concave_pf_30)
...
PGIPRO_vs_GPPE_experiment = InteractiveIproVsGPE(num_queries=number_of_queries,
                                                 ...
                                                 direction='minimize',
                                                 referent_selection_heuristic='middle_distance')
average_utility_gppe_exp_concave, average_utility_interactive_ipro_exp_concave, average_max_utility_gppe_exp_concave, \
    average_max_utility_interactive_ipro_exp_concave, std_dev_utility_gppe_exp_concave, std_dev_utility_interactive_ipro_exp_concave, \
    std_dev_max_utility_gppe_exp_concave, std_dev_max_utility_interactive_ipro_exp_concave, _, _, _ = PGIPRO_vs_GPPE_experiment.run()
...
plt.errorbar(
    ...
    capsize=5,
    color='r',
    label='PG-IPRO (convex PF)'
)
plt.errorbar(
    np.arange(1, len(average_utility_gppe_exp_concave) + 1),
    average_utility_gppe_exp_concave,
    yerr=std_dev_utility_gppe_exp_concave,
    fmt='--o',
    capsize=5,
    color='c',
    label='GPPE (concave PF)'
)
plt.errorbar(
    np.arange(1, len(average_utility_interactive_ipro_exp_concave) + 1),
    average_utility_interactive_ipro_exp_concave,
    yerr=std_dev_utility_interactive_ipro_exp_concave,
    fmt='--o',
    capsize=5,
    color='m',
    label='PG-IPRO (concave PF)'
)
plt.ylim(-0.1, 1.1)
...
plt.errorbar(
    np.arange(1, len(average_max_utility_gppe_exp_concave) + 1),
    average_max_utility_gppe_exp_concave,
    yerr=std_dev_max_utility_gppe_exp_concave,
    fmt='--o',
    capsize=5,
    color='c',
    label='GPPE (concave PF)'
...
plt.errorbar(
    np.arange(1, len(average_max_utility_interactive_ipro_exp_concave) + 1),
    average_max_utility_interactive_ipro_exp_concave,
    yerr=std_dev_max_utility_interactive_ipro_exp_concave,
    fmt='--o',
    capsize=5,
    color='m',
    label='PG-IPRO (concave PF)'
